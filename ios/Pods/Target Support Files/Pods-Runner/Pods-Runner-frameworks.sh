...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/dropbox_client/dropbox_client.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_photo_editor/flutter_photo_editor.framework"
